...
static ssize_t food_read(struct file* filp, char* buf, size_t count, loff_t* pos){
	...
	char sushi[] = {0xF0,0x9F,0x8D,0xA3,0x00};
	char pudding[] = {0xF0,0x9F,0x8D,0xAE,0x00};
	char riceball[] = {0xF0,0x9F,0x8D,0x99,0x00};
	char hamburger[] = {0xF0,0x9F,0x8D,0x94,0x00};
	char curryrice[] = {0xF0,0x9F,0x8D,0x9B,0x00};
	char bread[] = {0xF0,0x9F,0x8D,0x9E,0x00};
	char wineglass[] = {0xF0,0x9F,0x8D,0xB7,0x00};
	char sunflower[] = {0xF0,0x9F,0x8C,0xBB,0x00};
	char mapleleaf[] = {0xF0,0x9F,0x8D,0x81,0x00};
	char aubergine[] = {0xF0,0x9F,0x8D,0x86,0x00};
	// 空白を入れないとなぜかシェルの上の方で文字が切れる
	char nl[] = {' ','\n',0x00};
